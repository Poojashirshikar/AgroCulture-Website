                ...
                <form method="post" action="Profile/updateProfile.php">
                    <div class="row uniform">
                        ...
                        <div class="4u 12u$(xsmall)">
                            <input type="text" name="mobile" id="mobile" value="" placeholder="Mobile No" required />
                        </div>
                        ...
                        <div class="6u 12u$(xsmall)">
                            <div class="select-wrapper">
                              <select name="section" id="section">
                                    <option label="choose a section"value="Section"></option>
                        ...
                        <div class="6u 12u$(xsmall)">
                            <input type="text" name="post" id="post" value="" placeholder="Post Name" required/>
                        </div>
                        <p>
                            <b>Education : </b>
                        </p>
